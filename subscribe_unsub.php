<?php
    ...
    $g = new EmailsGateway();
    $result = $g->unsubscribe($_REQUEST['token']);
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="col s12">
                <?php if(true) { ?>
                <h3>Email successfully unsubscribed. Enjoy.</h3>
                <?php } else { ?>
                <h3>An error occurred while attempting to remove your email, please try again eventually.</h3>
                <?php } ?>
            </div>
        </div>
