...
<body>
  ...
  <div class="section no-pad-bot light-blue" id="index-banner">
    <div class="container">
      ...
      <?php
      include_once 'Gateways/TeamsGateway.php'
        ...
        <div class="col s12 l4">
          <div class="card large">
            <div class="card-image">
              <canvas id="$teams[0][0]" style="padding-left: 0;padding-right: 0;margin-left: auto;margin-right: auto;display: block;"width="215" height="220"></canvas>
            </div>
